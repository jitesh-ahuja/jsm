var JobFieldworkers = function () {

    var handleJobFieldworkers = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                ajax: { "url": "/report/jobsperfieldworker", }, // ajax source
                columns: [
                    {
                        data: "Code",
                        orderable: true,
        ...
        $('#btn_search').on('click', function (event) {
            ...
            var frm_array = $('#frm_fieldworker_jobs').serializeArray();
